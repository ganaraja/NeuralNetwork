...
from svlearn_autoencoders.auto_encoders.resnet_auto_encoder_modified import ResNetAutoEncoderModified
...
'''
The original Resnet Antoencoder class inspired from Resnet50 (from the [link](https://github.com/Horizon2333/imagenet-autoencoder/blob/main/models/resnet.py))
'''
