...
from svlearn_gan.dcgan_datasets import load_task_specific_dataset
from svlearn_gan.conditional_dcgan import load_task_specific_conditional_networks
from svlearn.common.utils import ensure_directory, directory_writable
from svlearn_gan.gan_trainer import train_func, load_checkpoint
...
if __name__ == "__main__":
    ...
    netG, netD = load_task_specific_conditional_networks(device, nc, nz, ngf, ndf, num_classes)
