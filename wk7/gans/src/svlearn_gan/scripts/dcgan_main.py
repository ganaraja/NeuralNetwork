...
from svlearn_gan import current_task
from svlearn_gan.dcgan_datasets import load_task_specific_dataset
from svlearn_gan.dcgan_models import load_task_specific_networks
...
#  -------------------------------------------------------------------------------------------------
    ...
    netG , netD = load_task_specific_networks(device, nc, nz, ngf, ndf)
