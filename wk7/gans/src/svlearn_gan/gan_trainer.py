...
from svlearn_gan.dcgan_models import weights_init
from svlearn_gan.conditional_dcgan import ConditionalDiscriminator, ConditionalGenerator
...
def load_checkpoint(model: nn.Module, checkpoint_file: str):
    if os.path.isfile(checkpoint_file):
        checkpoint_dis = torch.load(checkpoint_file, weights_only=False)
